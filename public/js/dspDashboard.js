		...
		.controller('vminfoController', ['$state', '$stateParams', '$http', function($state, $stateParams, $http){
			...
			switch(virtCon.params.serverId) {
				case "1":
					...
					virtCon.url = '/dspgroup/' + virtCon.params.vmid;
					break;
				case "2":
					virtCon.name = "LabServer01";
					virtCon.url = '/dsplab01/' + virtCon.params.vmid;
					break;
				case "3":
					virtCon.name = "LabServer02";
					virtCon.url = "/dsplab02/" + virtCon.params.vmid;
					break;
				case "4":
					virtCon.name = "LabServer03";
					virtCon.url = "/dsplab03/" + virtCon.params.vmid;
					break;
				case "5":
					virtCon.name = "LabServer04";
					virtCon.url = "/dsplab04/" + virtCon.params.vmid;
					break;
				default:
				...
				$http({
					method: 'GET',
					url: "/capacity" + virtCon.url
				}).then(function successCallback(response){
					console.log("Capacity recieved");
					console.log(response.data);
					virtCon.capacity = response.data;
				}, function errorCallback(response){
					console.log('Error, no data recieved');
				});
